...
class _$CityModelImpl with DiagnosticableTreeMixin implements _CityModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'CityModel(name: $name, latitude: $latitude, longitude: $longitude, countryCode: $countryCode, admin1: $admin1)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('admin1', admin1));
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, name, latitude, longitude, countryCode, admin1);
...
abstract class _CityModel implements CityModel {
  const factory _CityModel(
      ...
      final String? admin1}) = _$CityModelImpl;
